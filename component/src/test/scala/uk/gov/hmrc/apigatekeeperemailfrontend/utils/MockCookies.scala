...
object MockCookies {
  def makeCookieValue(application: PlayApplication) = makeSessionCookie(application).value
  ...
  def makeSessionCookie(app: PlayApplication): Cookie = {
  ...
  def makeWsCookie(application: PlayApplication) = {
  ...
  def makeSeleniumCookie(application: PlayApplication) = {
